...
/**
 * Created by varun on १६-०४-२०१७.
 */
...
/*
        ...
        ResponseEntity<ArrayList<TollUsage>> tolls = oAuth2RestTemplate.exchange("http://localhost:9001/services/tolls", HttpMethod.GET, null, new ParameterizedTypeReference<ArrayList<TollUsage>>(){});
